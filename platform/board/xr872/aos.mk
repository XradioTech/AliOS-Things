...
ifeq ($(with_rom),1)
ifeq ($(with_xip),1)
GLOBAL_LDFLAGS += -T platform/board/xr872/project-xip-rom.ld
else
GLOBAL_LDFLAGS += -T platform/board/xr872/project-noxip-rom.ld
endif
else
ifeq ($(with_xip),1)
GLOBAL_LDFLAGS += -T platform/board/xr872/project-xip-norom.ld
else
GLOBAL_LDFLAGS += -T platform/board/xr872/project-noxip-norom.ld
endif
endif
